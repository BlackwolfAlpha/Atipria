function applySavedTheme() {
    ...
    if (savedTheme === 'dark') {
        body.classList.add('bg-black', 'text-white', 'dark-theme');
        body.classList.remove('bg-white', 'text-black', 'light-theme');
        ...
        body.classList.add('bg-white', 'text-black', 'light-theme');
        body.classList.remove('bg-black', 'text-white', 'dark-theme');
